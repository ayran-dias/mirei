      ...
      >
        ...
        {customColors.length > 0 && (
          <div className="mb-2.5">
            <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-1.5">Custom</p>
        ...
        <div className="border-t border-gray-100 pt-2.5">
          <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-1.5">Custom hex</p>
