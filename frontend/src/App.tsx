...
import type { StatusCreditoRow, NpvCredito, PnlAdquirenciaRow, FluxoCreditoRow, Afiliacao360, BancoMedia, InsightsAdqRow } from './types'
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f5fff5]">
      ...
      <header className="bg-[#00461e]">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <span className="bg-[#00d700] text-[#00461e] text-xs font-bold px-3 py-1 rounded-full">Mesa Banco</span>
          </div>
        </div>
      </header>
      ...
      {currentPage === 'doc-felicia360' && <DocFelicia360 />}
      {currentPage === 'roadmap-mesa-banco' && <RoadmapMesaBanco />}
      {currentPage !== 'home' && currentPage !== 'enterprise' && currentPage !== 'felicia360' && currentPage !== 'ajuste-ofertas' && currentPage !== 'grupos-marca' && currentPage !== 'doc-felicia360' && currentPage !== 'roadmap-mesa-banco' && (
      ...
      <AnimatedHero className="px-6 py-12">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-white font-extrabold text-4xl leading-tight mb-3">Felícia 360</h1>
